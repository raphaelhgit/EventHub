...
export async function createEvent(req, res) {
    try {
        ...
        const { title, description, date, time, location, city, price, totalPlaces, category, image, } = req.body;
        ...
        const event = db.events.create({ title, description, date, time, location, city, price, totalPlaces, category, image }, req.user.sub);
